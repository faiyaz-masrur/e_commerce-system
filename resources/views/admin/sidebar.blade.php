<nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" style="color: white;" href="{{url('/redirect')}}"><b>Array Admin Panal</b></a>
          <a class="sidebar-brand brand-logo-mini" style="color: white;" href="{{url('/redirect')}}">A</a>
        </div>
        <ul class="nav">
